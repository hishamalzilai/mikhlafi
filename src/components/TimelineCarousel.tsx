        ...
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-sm text-slate-500 group-hover/card:text-white transition-colors duration-500 leading-relaxed font-bold border-r-2 border-slate-700 group-hover/card:border-[#b18c39] pr-6">{item.desc}</p>
            </div>
          );
        })}
      </div>
