...
const DEFAULT_HOMEPAGE: HomepageContent = {
  ...
  hero_quote: 'سيادة مؤسسات الدولة هي الضمانة الوحيدة لمستقبل اليمن الاتحادي',
  hero_subtitle: 'مفكر وسياسي يمني',
  vision_quote: 'إن بناء الدولة اليمنية الحديثة يبدأ من احترام الدستور وتفعيل سلطة القانون، والتمسك بالثوابت الوطنية.',
};
